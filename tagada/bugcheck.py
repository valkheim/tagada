...
BUG_CHECK_CODES = {
    ...
    0x000000C3: "BUG_CHECK_C3",  # KeBugCheck2
    ...
    0x000000E5: "BUG_CHECK_E5",  # KeBugCheck2
...
def run() -> None:
    enum = new_enum("BUG_CHECK_CODES", BUG_CHECK_CODES)
    hooks = {
        "ntoskrnl.exe": [
            ("KeBugCheck", 1),
            ("KeBugCheck2", 1),
            ...
            ("KiBugCheckDispatch", 1),
            ("VerifierBugCheckIfAppropriate", 1),
            ("VfFailDriver", 1),
        ]
    }
